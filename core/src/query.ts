import type { Args, Getter, Invocation, Methods } from "./call"
...
export type Query<K extends string, A extends Args, R, M extends Methods = "GET"> = Invocation<K, A, R, "query", M>
